...
class __TwigTemplate_b68cdcd69e416ee42d8ef90f26017ae5036297e407e648e505925b07c9c6dd18 extends Twig_Template
{
    ...
    <div class=\"piwik-donate-message\">
        ...
        if (array_key_exists("msg", $context)) {
            // line 4
            echo "            ";
            echo \Piwik\piwik_escape_filter($this->env, (isset($context["msg"]) ? $context["msg"] : $this->getContext($context, "msg")), "html", null, true);
            echo "
        ";
        } else {
            // line 6
...
\t\t\t<a class=\"donate-spacer\">";
    ...
    ";
        ...
        if (array_key_exists("footerMessage", $context)) {
            ...
            ";
            // line 52
            echo \Piwik\piwik_escape_filter($this->env, (isset($context["footerMessage"]) ? $context["footerMessage"] : $this->getContext($context, "footerMessage")), "html", null, true);
            echo "
        </div>
    ";
        }
